...
urlpatterns = [
    ...
    path('<int:pk>/problems/<slug:slug>/status/', views.get_user_status_on_problems_in_competition, name='get_user_problem_status'),
    path('<int:pk>/problems/<slug:slug>/delete/', views.delete_problem_from_competition,  name='delete_problem_from_competition'),
